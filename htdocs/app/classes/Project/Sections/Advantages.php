...
class Advantages extends \A365\Wordpress\Block\AcfBlock {
	...
	protected static $_label = 'Technologie Vorteile';
	...
	public static function getAcfSubfields()
	{
		return [
				...
				FieldHelper::createImageCrop('big_image', 'Bild groß', ["crop_type" => "hard", 'target_size' => 'custom', 'force_crop' => 'yes', 'save_format' => 'url', "width" => 620, "height" => 620])->setRequired(),
				];
	}
}