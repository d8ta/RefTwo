	...
	public static function getAcfSubfields()
	{
		return [
			FieldHelper::createRepeater('links', 'Links', ["min" => 3, "max" => 3])
				->addSubfields([
					FieldHelper::createImageCrop('image', 'Bild', ["crop_type" => "hard", 'target_size' => 'custom', 'force_crop' => 'yes', 'save_format' => 'url', "width" => 180, "height" => 200])->setRequired(),					
					FieldHelper::createImageCrop('logo', 'Logo', ["crop_type" => "hard", 'target_size' => 'custom', 'force_crop' => 'yes', 'save_format' => 'url', "width" => 180, "height" => 200])->setRequired(),
