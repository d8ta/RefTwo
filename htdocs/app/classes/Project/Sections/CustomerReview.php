...
class CustomerReview extends \A365\Wordpress\Block\AcfBlock {
	...
	public static function getAcfSubfields()
	{
		return [
				...
				FieldHelper::createImageCrop('big_image', 'Forschungsbild groß', ["crop_type" => "hard", 'target_size' => 'custom', 'force_crop' => 'yes', 'save_format' => 'url', "width" => 580, "height" => 580])->setRequired(),
